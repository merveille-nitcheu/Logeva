							...
							<div class="menu menu-column menu-title-white menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								<div class="menu-item">
									<div class="menu-content pb-2">
										<span class="menu-section text-muted text-uppercase fs-7 ls-2">Admin</span>
									</div>
								</div>
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                    ...
                                    <div class="menu-sub menu-sub-accordion" kt-hidden-height="115" style="display: none; overflow: hidden;">
                                     <div class="menu-item">
                                            <a class="menu-link" href="{{url('proprietaire')}}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Liste de Proprietaire</span>
                                            </a>
                                        </div>
                                        
                                     <div class="menu-item">
                                       <a class="menu-link" href="{{url(('proprietaire/create'))}}">
                                                <span class="menu-bullet">
                                                    <span class="bullet bullet-dot"></span>
                                                </span>
                                                <span class="menu-title">Ajouter Proprietaire</span>
                                            </a>
                                        </div>
								...
								<div class="menu-item">
									<a class="menu-link" href="{{url('locataire')}}">
										 <span class="menu-icon">
                                            <!--begin::Svg Icon | path: icons/duotone/Communication/Group.svg-->
                                            <span class="svg-icon svg-icon-2">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
										...
										<div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
											...
											<div class="menu-item px-3">
												...
												<div class="menu-item px-5">
													<a href="{{route('profiladmin')}}" class="menu-link px-5">Mon Profil
													</a>
												</div>
												<div class="menu-item px-5">
													<a href="{{route(('deconnexion2'))}}"  class="menu-link px-5">Deconnexion</a>
												</div>
