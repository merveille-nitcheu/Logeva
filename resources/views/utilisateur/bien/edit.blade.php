...
<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
    ...
    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
        <!--begin::Title-->
        <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Edit Bien</h1>
        <!--end::Title-->
        <!--begin::Separator-->
...
@section('content')
    <div class="col-12">
        <div class="card card-primary">
            {{ Form::open(['url' => '/bien/'.$bien->slug, 'method' => 'PUT','enctype'=>'multipart/form-data']) }}
            ...
            <div class="card-body bg-light justify-content-center">
                ...
                <div class="col-12 d-md-flex mb-5">
                    <div class="form-group col-md-6 me-7">
                        ...
                        {!! Form::text('nom', $bien->nom, ['class' => $errors->has('nom') ? 'is-invalid form-control' : 'form-control']) !!}
                    ...
                    <div class="form-group col-md-6 me-7  pe-2">
                        ...
                        {!! Form::select('id_typeBien',$typeBien ,$bien->typeBien->id,['class'=>'form-select ', 'data-control'=>'select2', 'data-placeholder'=>'Selectionner un type', 'data-allow-clear'=>'true']) !!}
                        <div class="invalid-feedback">
                            {{ $errors->first('type') }}
                        </div>
                    </div>
                ...
                <div class="col-12 d-md-flex mb-5">
                    <div class="form-group col-md-3 me-4">
                        ...
                        {!! Form::number('nombre_piece',$bien->nombre_piece, ['class' => $errors->has('nombre_pieces') ? 'is-invalid form-control' : 'form-control']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-md-3 me-4">
                        ...
                        {!! Form::number('surface', $bien->surface, ['class' => $errors->has('nom') ? 'is-invalid form-control' : 'form-control']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-md-6 me-4  pe-2">
                        ...
                        {!! Form::text('adresse',$bien->adresse, ['class' => $errors->has('nom') ? 'is-invalid form-control' : 'form-control']) !!}
                        <div class="invalid-feedback">
                ...
                <div class="col-12 d-md-flex mb-5">
                    <div class="form-group col-md-6 me-7">
                        ...
                        {!! Form::text('pays', $bien->pays, ['class' => $errors->has('pays') ? 'is-invalid form-control' : 'form-control']) !!}
                        <div class="invalid-feedback">
                            {{ $errors->first('pays') }}
                        </div>
                    </div>
                    <div class="form-group col-md-6 me-7 pe-2">
                        ...
                        {!! Form::text('ville', $bien->ville, ['class' => $errors->has('nom') ? 'is-invalid form-control' : 'form-control']) !!}
                        <div class="invalid-feedback">
                            {{ $errors->first('ville') }}
                        </div>
                    </div>
                ...
                <div class="col-12 d-md-flex mb-5">
                    <div class="form-group col-md-6 me-7">
                        ...
                        {!! Form::text('code_postal', $bien->code_postal, ['class' => $errors->has('code_postal') ? 'is-invalid form-control' : 'form-control']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-md-6 me-7 pe-2 ">
                        ...
                        {!! Form::text('centre_imposition', $bien->centre_imposition, ['class' => $errors->has('centre_imposition') ? 'is-invalid form-control' : 'form-control']) !!}
                        <div class="invalid-feedback">
                ...
                <div class="col-12 d-md-flex mb-5">
                    <div class="form-group col-md-3 me-3 ">
                        ...
                        {!! Form::number('nombre_lot', $bien->nombre_lot, ['class' => $errors->has('nombre_lots') ? 'is-invalid form-control' : 'form-control']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-md-3 me-3 ">
                        ...
                        {!! Form::number('nombre_batiment', $bien->nombre_batiment, ['class' => $errors->has('nombre_batiments') ? 'is-invalid form-control' : 'form-control']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-md-3 me-3 ">
                        ...
                        {!! Form::number('nombre_etage', $bien->nombre_etage, ['class' => $errors->has('nombre_etages') ? 'is-invalid form-control' : 'form-control', 'placeholder' => 'Votre mot de passe']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group col-md-3 me-7 pe-2 ">
                        ...
                        {!! Form::number('nombre_escalier', $bien->nombre_escalier, ['class' => $errors->has('nombre_escaliers') ? 'is-invalid form-control' : 'form-control', 'placeholder' => 'Veuillez récrire votre mot de passe']) !!}
                        <div class="invalid-feedback">
                ...
                <div class="col-12 d-md-flex mb-5">
                    <div class="form-group col-md-6 me-7">
                        ...
                        {!! Form::number('numero_porte', $bien->numero_porte, ['class' => $errors->has('nombre_portes') ? 'is-invalid form-control' : 'form-control']) !!}
                        <div class="invalid-feedback">
                ...
                <div class="col-12 d-md-flex mb-5">
                    <div class="form-check form-switch form-check-custom form-check-solid justify-content-between">
                        {!! Form::label('zone_stationement', 'Zone de stationement') !!}
                        {!! Form::checkbox('zone_stationement', $bien->zone_stationement, 'zone_stationement', ['class' => 'form-check-input h-25px w-35px me-10 ms-15']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-check form-switch form-check-custom form-check-solid justify-content-between">
                        ...
                        {!! Form::checkbox('garage', $bien->garage, 'garage', ['class' => 'form-check-input h-25px w-35px me-10 ms-15']) !!}
                        <div class="invalid-feedback">
                            {{ $errors->first('garage') }}
                        </div>
                    </div>
                    <div class="form-check form-switch form-check-custom form-check-solid justify-content-between">
                        ...
                        {!! Form::checkbox('cave', $bien->cave, 'cave', ['class' => 'form-check-input h-25px w-35px me-10 ms-15']) !!}
                        <div class="invalid-feedback">
                            {{ $errors->first('cave') }}
                        </div>
                    </div>                  
                    <div class="form-check form-switch form-check-custom form-check-solid justify-content-between">
                        ...
                        {!! Form::checkbox('gardiennage', $bien->gardiennage, 'gardiennage', ['class' => 'form-check-input h-25px w-35px me-10 ms-15']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-check form-switch form-check-custom form-check-solid justify-content-between">
                        ...
                        {!! Form::checkbox('interphone', $bien->interphone, 'interphone', ['class' => 'form-check-input h-25px w-35px me-10 ms-15']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-check form-switch form-check-custom form-check-solid justify-content-between">
                        ...
                        {!! Form::checkbox('ascenseur', $bien->ascenseur, 'ascenseur', ['class' => 'form-check-input h-25px w-35px me-10 ms-15']) !!}
                        <div class="invalid-feedback">
                ...
                <div class="col-12 d-md-flex mb-5">
                    ...
                    <div class="form-check form-switch form-check-custom form-check-solid justify-content-between me-5">
                        ...
                        {!! Form::checkbox('vide_ordure', $bien->vide_ordure, 'vide_ordure', ['class' => 'form-check-input h-25px w-35px me-10 ms-15']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-check form-switch form-check-custom form-check-solid justify-content-between me-5">
                        ...
                        {!! Form::checkbox('espaces_vert', $bien->espaces_vert, 'espaces_vert', ['class' => 'form-check-input h-25px w-35px me-10 ms-15']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-check form-switch form-check-custom form-check-solid justify-content-between">
                        ...
                        {!! Form::checkbox('chauffage_collectif', $bien->chauffage_collectif, 'chauffage_collectif', ['class' => 'form-check-input h-25px w-35px me-10 ms-15']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-check form-switch form-check-custom form-check-solid justify-content-between">
                        ...
                        {!! Form::checkbox('eau_chaude_collective', $bien->eau_chaude_collective, 'eau_chaude_collective', ['class' => 'form-check-input h-25px w-35px me-10 ms-15']) !!}
                        <div class="invalid-feedback">
                    ...
                    <div class="form-check form-switch form-check-custom form-check-solid justify-content-between">
                        ...
                        {!! Form::checkbox('antenne_tv_collective', $bien->antenne_tv_collective, 'antenne_tv_collective', ['class' => 'form-check-input h-25px w-35px me-10 ms-15']) !!}
                        <div class="invalid-feedback">
