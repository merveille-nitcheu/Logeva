...
<div class="d-flex flex-column flex-root">
            ...
            <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-size1: 100% 50%; background-color:#181c32">
                <!--begin::Content-->
                <div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
                    ...
                    <div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                        <!--begin::Form-->
                            ...
                            {{ Form::open(['url' => route('inscriptionadmin'), 'method' => 'POST']) }}
                            <!--begin::Heading-->
                            <div class="mb-10 text-center">
                                ...
                                <a href="{{ route('connexionformadmin') }}" class="link-primary fw-bolder">Se connecter ici</a></div>
                                <!--end::Link-->
                            </div>
