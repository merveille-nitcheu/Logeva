							...
							<div class="menu menu-column menu-title-white menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
								<div class="menu-item">
									<div class="menu-content pb-2">
										<span class="menu-section text-muted text-uppercase fs-7 ls-2">Locataire</span>
									</div>
								</div>
								...
								<div class="menu-item">
									<a class="menu-link" href="{{route('afficherbienlocat')}}">
										...
										<span class="menu-title"> Mon Bien</span>
									</a>
								</div>
